import { base64ToBytes, bytesToBase64, bytesToHex, concatBytes, EMPTY_BYTES, TEXT_DECODER, TEXT_ENCODER, toBytesView } from 'zapo-js/util';
...
export function writeUInt16BE(buf, value, offset) {
    ensureBounds(buf, offset, 2);
...
export function writeUInt32LE(buf, value, offset) {
    ensureBounds(buf, offset, 4);
...
export function writeBigUInt64BE(buf, value, offset) {
