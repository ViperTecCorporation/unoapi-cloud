 ...
 */
export function selectMediaRelayEndpoint(endpoints, incoming) {
 ...
 */
export function orderMediaRelayCandidates(endpoints, incoming) {
...
export function normalizeRelayEndpoints(endpoints, options = {}) {
    const seen = new Set();
