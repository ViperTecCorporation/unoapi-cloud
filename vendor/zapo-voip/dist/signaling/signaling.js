...
async function buildAcceptStanza(callId, peerJid, callCreator, isVideo) {
    const acceptContent = [
...
function buildPreacceptStanza(peerJid, callId, callCreator) {
    return {
        tag: 'call',
        attrs: { to: peerJid, id: generateCallStanzaId() },
        content: [
