...
export declare enum EndCallReason {
...
export declare const DEFAULT_AUDIO_CONFIG: WaAudioEngineConfig;
export declare const SRTP_SEND_AUTH_TAG_LEN = 4;
export declare const SRTP_RECV_AUTH_TAG_LEN = 4;
export declare const SRTP_AUTH_TAG_LEN = 4;
export declare const SRTP_LABEL: {
    readonly ENCRYPTION: 0;
    readonly AUTH: 1;
    readonly SALT: 2;
};
export declare const WA_RELAY_PORT = 3480;
export declare const WA_DTLS_FINGERPRINT = "sha-256 F9:CA:0C:98:A3:CC:71:D6:42:CE:5A:E2:53:D2:15:20:D3:1B:BA:D8:57:A4:F0:AF:BE:0B:FB:F3:6B:0C:A0:68";
