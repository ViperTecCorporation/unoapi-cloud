...
import { isLegacySession, isOnlineStatus, sessionLabel, sessionPhone } from '../domain/session.js?v=4.0.0-beta10-6cbd5fc8';
import { renderContactCards, renderGroupCards } from '../features/entities.js?v=4.0.0-beta10-6cbd5fc8';
import { renderSessionConfig } from '../features/session_config.js?v=4.0.0-beta10-6cbd5fc8';
import { renderWebhooks } from '../features/webhooks.js?v=4.0.0-beta10-6cbd5fc8';
import { formatNumber, t } from '../core/i18n.js?v=4.0.0-beta10-6cbd5fc8';
const tabs = [
