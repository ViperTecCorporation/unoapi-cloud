...
import { renderStatus } from '../components/status.js?v=4.0.21-038921da';
import { escapeHtml } from '../core/html.js?v=4.0.21-038921da';
import { isLegacySession, isOnlineStatus, sessionLabel, sessionPhone } from '../domain/session.js?v=4.0.21-038921da';
import { CONTACT_SEARCH_MIN_LENGTH, renderContactCards, renderGroupCards } from '../features/entities.js?v=4.0.21-038921da';
import { renderSessionConfig } from '../features/session_config.js?v=4.0.21-038921da';
import { renderWebhooks } from '../features/webhooks.js?v=4.0.21-038921da';
import { formatNumber, t } from '../core/i18n.js?v=4.0.21-038921da';
const tabs = [
