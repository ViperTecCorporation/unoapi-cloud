import { icon } from '../components/icons.js?v=4.0.1-1cf00d03';
import { renderStatus } from '../components/status.js?v=4.0.1-1cf00d03';
import { escapeHtml } from '../core/html.js?v=4.0.1-1cf00d03';
import { isLegacySession, isOnlineStatus, sessionLabel, sessionPhone } from '../domain/session.js?v=4.0.1-1cf00d03';
import { renderContactCards, renderGroupCards } from '../features/entities.js?v=4.0.1-1cf00d03';
import { renderSessionConfig } from '../features/session_config.js?v=4.0.1-1cf00d03';
import { renderWebhooks } from '../features/webhooks.js?v=4.0.1-1cf00d03';
import { formatNumber, t } from '../core/i18n.js?v=4.0.1-1cf00d03';
const tabs = [
