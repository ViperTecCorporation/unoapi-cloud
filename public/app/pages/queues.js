import { renderInfoTooltip } from '../components/form_controls.js?v=4.0.27-038921da';
import { icon } from '../components/icons.js?v=4.0.27-038921da';
import { renderModal } from '../components/modal.js?v=4.0.27-038921da';
import { escapeHtml } from '../core/html.js?v=4.0.27-038921da';
import { formatNumber, t } from '../core/i18n.js?v=4.0.27-038921da';
import { sessionLabel, sessionPhone } from '../domain/session.js?v=4.0.27-038921da';
import { parseRabbitQueueName, rabbitQueueScopeLabels } from '../domain/rabbit_queue.js?v=4.0.27-038921da';
