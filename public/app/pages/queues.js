import { renderInfoTooltip } from '../components/form_controls.js?v=4.0.14-02421e46';
import { icon } from '../components/icons.js?v=4.0.14-02421e46';
import { renderModal } from '../components/modal.js?v=4.0.14-02421e46';
import { escapeHtml } from '../core/html.js?v=4.0.14-02421e46';
import { formatNumber, t } from '../core/i18n.js?v=4.0.14-02421e46';
import { sessionLabel, sessionPhone } from '../domain/session.js?v=4.0.14-02421e46';
import { parseRabbitQueueName, rabbitQueueScopeLabels } from '../domain/rabbit_queue.js?v=4.0.14-02421e46';
