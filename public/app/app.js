import { ApiClient, ApiError } from './core/api.js?v=4.0.27-038921da';
import { digitsOnly, escapeHtml, messageRecipient } from './core/html.js?v=4.0.27-038921da';
import { getLocale, normalizeLocale, setLocale, t } from './core/i18n.js?v=4.0.27-038921da';
import { SocketBridge } from './core/socket.js?v=4.0.27-038921da';
import { renderLayout, renderLogin } from './components/layout.js?v=4.0.27-038921da';
import { isLegacySession, sessionPhone } from './domain/session.js?v=4.0.27-038921da';
import { mergeRedisTreeLevel, redisParentPrefix } from './domain/redis_tree.js?v=4.0.27-038921da';
import { shouldRenderBackgroundUpdate } from './domain/render_policy.js?v=4.0.27-038921da';
import { ContactPictureLoader } from './domain/contact_picture_loader.js?v=4.0.27-038921da';
import { sessionConfigPayload } from './features/session_config.js?v=4.0.27-038921da';
import { renderConfirmDeregisterModal, renderConnectionModal, renderMessageModal, renderNewSessionModal } from './features/session_modals.js?v=4.0.27-038921da';
import { renderWebhookModal, webhookPayload } from './features/webhooks.js?v=4.0.27-038921da';
import { renderDashboard } from './pages/dashboard.js?v=4.0.27-038921da';
import { DOCUMENTATION_ORIGIN, renderDocumentationPage } from './pages/documentation.js?v=4.0.27-038921da';
import { renderSessionPage } from './pages/session.js?v=4.0.27-038921da';
import { renderQueuePurgeModal, renderQueuesPage } from './pages/queues.js?v=4.0.27-038921da';
import { renderRedisDeleteModal, renderRedisEditorModal, renderRedisPage } from './pages/redis.js?v=4.0.27-038921da';
import { CONTACT_SEARCH_MIN_LENGTH, filterContacts, filterGroups } from './features/entities.js?v=4.0.27-038921da';
import { renderVoipCredentialsModal, renderVoipPage, renderVoipRecordingSettingsModal, renderVoipResourceModal, } from './pages/voip.js?v=4.0.27-038921da';
import { icon } from './components/icons.js?v=4.0.27-038921da';
